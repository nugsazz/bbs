      ...
      #                          wait["blacklist"][target] = True
       #                         f=codecs.open('st2__b.json','w','utf-8')
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
            ...
            elif msg.text in ["Me","Gu"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
                cl.sendMessage(msg)
            elif msg.text in ["Me5","Gu5"]:
                msg.contentType = 13
                ...
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Gift10"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
            ...
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","All gift","Gu gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '12'}
...
#-----------------------------------------------
                ...
                kk.sendText(msg.to,"on 􀜁􀅔􀜁􀅔Har Har􏿿")
                ki.sendText(msg.to,"Ok Phet ")
                kk.sendText(msg.to,"on 􀜁􀅔􀜁􀅔Har Har􏿿")
                ki.sendText(msg.to,"Ok Phet ")
                kk.sendText(msg.to,"on 􀜁􀅔􀜁􀅔Har Har􏿿")
